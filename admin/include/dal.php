...
class tDAL
{
	...
	var $tblcivil_at_localhost__user;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		...
		$this->lstTables[] = array("name" => "user", "varname" => "civil_at_localhost__user", "altvarname" => "user", "connId" => "civil_at_localhost", "schema" => "", "connName" => "civil at localhost");
	}
