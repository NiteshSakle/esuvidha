...
function reffered($cirid){
 $query1="select  name  from refcir where cirid='$cirid'";
 $rw1=mysql_query($query1);
 if($row11=mysql_fetch_object($rw1))
 return $row11->name;
 }
...
?>
  ...
  <table width="100%" border="1" cellspacing="2" cellpadding="2">
    ...
    <tr>
       ...
       <th>Subject</th>
       <th>Circular No</th>
       <th colspan="2">Reffered To</th>

     </tr>
    	<?php while($row =mysql_fetch_array($result)) { ?>
    <tr>

       <td bgcolor="red"><a href="view.php?cirid=<?php echo $row['cirid']?>"><?php echo $row['cirid'] ; ?></a></td>
       <td><?php echo strtoupper(deptName($row['sectionid'])); ?></td>
       <td><a href="view.php?cirid=<?php echo $row['cirid']?>"><?php echo $row['subject'] ; ?></a></td>
       <td><?php echo $row['circularno'] ; ?></td>
       <td colspan="2"><?php echo reffered($row['cirid']); ?></td>
