...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "civil_ticketmaster" ] = array( "url" => "civil_ticketmaster", "type" => 0 );
	$projectEntitiesReverse[ "civil_ticketmaster" ] = "civil_ticketmaster";
	$projectEntities[ "civil_ticketremarks" ] = array( "url" => "civil_ticketremarks", "type" => 0 );
	$projectEntitiesReverse[ "civil_ticketremarks" ] = "civil_ticketremarks";
	$projectEntities[ "civil_ticketmaster Report" ] = array( "url" => "civil_ticketmaster_Report", "type" => 2 );
	$projectEntitiesReverse[ "civil_ticketmaster_Report" ] = "civil_ticketmaster Report";
}
