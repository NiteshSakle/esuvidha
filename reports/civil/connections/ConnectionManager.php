...
class ConnectionManager
{
	...
	{
		return $this->byId( "civil_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "civil_at_localhost";
		$data["connName"] = "civil at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;civil;;1"; //currently unused
		
		$this->_connectionsIdByName["civil at localhost"] = "civil_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "civil";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=civil;OPTION=3";
		// encription set
		...
		$connectionsData["civil_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["civil_ticketmaster"] = "civil_at_localhost";
		$connectionsIds["civil_ticketremarks"] = "civil_at_localhost";
		$connectionsIds["civil_ticketmaster Report"] = "civil_at_localhost";
