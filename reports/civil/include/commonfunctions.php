...
function checkTableName($shortTName, $type=false)
{
	...
	if ("civil_ticketmaster" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("civil_ticketremarks" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("civil_ticketmaster_Report" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	return false;
}
...
{
	$arr = array();
		$arr[]="civil_ticketmaster";
		$arr[]="civil_ticketremarks";
		$arr[]="civil_ticketmaster Report";
	return $arr;
}
...
//	default permissions
	if($table=="civil_ticketmaster")
	{
		// grant all by default
		return "ADESPI".$extraPerm;
	}
//	default permissions
	if($table=="civil_ticketremarks")
	{
		// grant all by default
		return "ADESPI".$extraPerm;
	}
//	default permissions
	if($table=="civil_ticketmaster Report")
	{
		// grant all by default
		return "ADESPI".$extraPerm;
	}
