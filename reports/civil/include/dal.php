...
class tDAL
{
	var $tblcivil_at_localhost__buildings;
	var $tblcivil_at_localhost__civil_ticketmaster;
	var $tblcivil_at_localhost__civil_ticketremarks;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "buildings", "varname" => "civil_at_localhost__buildings", "altvarname" => "buildings", "connId" => "civil_at_localhost", "schema" => "", "connName" => "civil at localhost");
		$this->lstTables[] = array("name" => "civil_ticketmaster", "varname" => "civil_at_localhost__civil_ticketmaster", "altvarname" => "civil_ticketmaster", "connId" => "civil_at_localhost", "schema" => "", "connName" => "civil at localhost");
		$this->lstTables[] = array("name" => "civil_ticketremarks", "varname" => "civil_at_localhost__civil_ticketremarks", "altvarname" => "civil_ticketremarks", "connId" => "civil_at_localhost", "schema" => "", "connName" => "civil at localhost");
	}
